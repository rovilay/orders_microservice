...
import (
	...
	"github.com/rovilay/orders-api/model"
	"github.com/rovilay/orders-api/repository/order"
)
...
func (o *Order) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	ordr, err := o.Repo.FindByID(r.Context(), orderID)
	...
	if err := json.NewEncoder(w).Encode(ordr); err != nil {
		fmt.Println("failed to marshal:", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
...
func (o *Order) UpdateByID(w http.ResponseWriter, r *http.Request) {
	...
	theOrder.OrderStatus = body.Status
